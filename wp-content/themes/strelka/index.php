		...
		<!-- head -->
	        <a href="<?php echo home_url('/'); ?>">
	            <div class="row" id="head">
		            <div id="head-content">
			            <div id="head-logo" class="col-md-2 col-sm-2 col-xs-4"><img class="img-responsive" src="<?php echo get_stylesheet_directory_uri() ?>/img/logo.png"></div>
				        <div id="head-title" class="col-md-6 col-sm-6 col-xs-8">
					        <div id="head-title-content">
                                <?php include 'head.php'; ?>
					        </div>
				        </div>
				        <div class="col-md-4 hidden-sm hidden-xs moto"><h3>... skauting pro život</h3></div>
					</div>
		        </div>
            </a>
	    <!-- primary menu -->
